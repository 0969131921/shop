				...
				<div class="panel-body">
					...
					<form method="post">
						<div class="form-group">
							...
							<input type="text" required name="name" class="form-control" placeholder="Tên danh mục...">
						</div>
						<div class="form-group">
							<input type="submit" name="submit" class="btn btn-primary form-control" value="Thêm mới" placeholder="Tên danh mục...">
						</div>
						{{csrf_field()}}
					</form>
				</div>
