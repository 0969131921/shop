		...
		<div class="container">
			<div class="row">
				<div id="logo" class="col-md-3 col-sm-12 col-xs-12">
					<h1>
						<a href="{{asset('/')}}"><img src="img/home/logo_duyet.png"></a>						
						<nav>
				...
				<div id="search" class="col-md-7 col-sm-12 col-xs-12">
					<form action="{{asset('search/')}}" method="get" class="navbar-form">
						<div class="input-group-btn">
							<input type="text" class="form-controll" placeholder="Search" name="result">
							<button class="btn btn-default my_buttons" type="submit">
								Tìm kiếm
							</button>
						</div>
					</form>
				...
				<div id="sidebar" class="col-md-3">
					<nav id="menu">
						<ul>
							...
							<li class="menu-item">
								<a href="{{asset('category/'.$cate->cate_id.'/'.$cate->cate_slug.'.html')}}" title="">{{$cate->cate_name}}</a>
							</li>
							@endforeach					
						</ul>
					</nav>
			...
			<div class="container">
				<div class="row">
					<div id="logo-f" class="col-md-3 col-sm-12 col-xs-12 text-center">
						<a href="#"><img src="img/home/logo_duyet.png"></a>
					</div>
					<div id="about" class="col-md-3 col-sm-12 col-xs-12">
						<h3>About us</h3>
						<p class="text-justify">Mr.Duyet Shop thành lập năm 2009. Chúng tôi bán hàng với mục tiêu là chất lượng hàng đầu. Các bạn có thể yên tâm khi đến với chúng tôi và không cần phải lo đến các dịch vụ của chúng tôi!</p>
					</div>
					<div id="hotline" class="col-md-3 col-sm-12 col-xs-12">
						<h3>Hotline</h3>
						<p>Phone Sale: (+84) 969 131 921</p>
						<p>Email: nguyenduyet0209@gmail.com</p>
					</div>
					<div id="contact" class="col-md-3 col-sm-12 col-xs-12">
						<h3>Contact Us</h3>
						<p>Địa chỉ: Hồ Tùng Mậu - Cầu Giấy - Hà Nội</p>
					</div>
				</div>
			</div>
			<div id="footer-b">
				<div class="container">
					<div class="row">
						<div id="footer-b-l" class="col-md-6 col-sm-12 col-xs-12 text-center">
							<p>Shop bán hàng Mr.Duyet</p>
						</div>
						<div id="footer-b-r" class="col-md-6 col-sm-12 col-xs-12 text-center">
							<p>© 2018 Mr.Duyet . All Rights Reserved</p>
						</div>
					</div>
				</div>
			</div>
